...
public final class MySignature {
    ...
    public static void initSign(PublicKey key) throws Exception {
        MySignature.chavePublica = key;
        cipher.init(Cipher.ENCRYPT_MODE, MySignature.chavePublica);
    }
    ...
    public static void initVerify(PrivateKey key) throws Exception{
        MySignature.chavePrivada = key;

        cipher.init(Cipher.DECRYPT_MODE, MySignature.chavePrivada);
    }
